// PeekMessage.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
    ...
    case WM_PAINT:
        {
            ...
            TCHAR strPoint[64] = {};
            wsprintf(strPoint, TEXT("Start = X : %d, Y : %d"), g_tPlayerRC.left, g_tPlayerRC.top);
            TextOut(hdc, 100, 50, strPoint, lstrlen(strPoint));
